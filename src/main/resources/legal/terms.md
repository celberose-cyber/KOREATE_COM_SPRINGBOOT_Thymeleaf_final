> [과제용 고지]
> 본 약관은 공정거래위원회 전자상거래 표준약관을 교육/과제 목적상 원문 그대로 인용한 것입니다.
> 본 프로젝트의 서비스명은 “KOREATE.COM”이며, 원문 내 “OO 회사”, “OO 사이버 몰”, “몰” 등의 표기는 표준약관 원문의 형식을 유지하기 위한 표현입니다.
> 실제 사업자정보(상호/대표/주소/사업자등록번호/통신판매업 신고번호 등)는 과제 범위상 생략되어 있으며, 실서비스 적용 시 별도 기재 및 법령 준수가 필요합니다.
